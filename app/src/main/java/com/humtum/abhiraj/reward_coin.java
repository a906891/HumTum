...
public class reward_coin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rewar_coin);
        ...
        {
            a = sharedPreferences.getString("coin","0");

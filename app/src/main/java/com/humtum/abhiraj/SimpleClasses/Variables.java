package com.humtum.abhiraj.SimpleClasses;
...
public class Variables {
    ...
    public static final String app_hided_folder =root+"/.HidedHumTum/";
    public static final String app_showing_folder =root+"/HumTum/";
   ...
   public static String gif_api_key1="QkVQ8sthzEOOemu4CIcndgvtqt209zG0";

    public static final String privacy_policy="https://humtum.flycricket.io/privacy.html";


     
    public static final  String main_domain="http://minevilla.xyz/";
